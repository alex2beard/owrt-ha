...
SENSOR_DESCRIPTIONS: tuple[OpenWrtSensorEntityDescription, ...] = (
    ...
    OpenWrtSensorEntityDescription(
        key="wan_rx_rate",
        translation_key="wan_rx_rate",
        value_fn=lambda data, language: _get_path(data, "interfaces", "wan", "rx_mbps"),
    ...
    OpenWrtSensorEntityDescription(
        key="wan_tx_rate",
        translation_key="wan_tx_rate",
        value_fn=lambda data, language: _get_path(data, "interfaces", "wan", "tx_mbps"),
        native_unit_of_measurement="Mbit/s",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
